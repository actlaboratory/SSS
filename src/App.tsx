        ...
        <>
            ...
            <InputRow
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    setParams({
                        ...params,
                        "tokutei_fuyou_shinzoku": Number(e.target.value)
                    })
                }}
            />
            ...
            <InputRow
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    setParams({
                        ...params,
                        "roujin_fuyou_shinzoku": Number(e.target.value)
                    })
                }}
            />
            ...
            <InputRow
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    setParams({
                        ...params,
                        "doukyo_roujin": Number(e.target.value)
                    })
                }}
            />
            ...
            <InputRow
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    setParams({
                        ...params,
                        "fuyou_shinzoku": Number(e.target.value)
                    })
                }}
            />
            ...
            <InputRow
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    setParams({
                        ...params,
                        doukyo_tokubetsu_shougai: Number(e.target.value)
                    })
                }}
            />
            ...
            <InputRow
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    setParams({
                        ...params,
                        tokubetsu_shougai: Number(e.target.value)
                    })
                }}
            />
            ...
            <InputRadioRow
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    setParams({
                        ...params,
                        "dokushin_type": Number(e.target.value)
                    })
                }}
            />
            ...
            <InputRadioRow
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    setParams({
                        ...params,
                        "gakusei_type": Number(e.target.value)
                    })
                }}
            />
            ...
            <div
                className="d-flex align-items-center text-white bg-primary px-3 mt-5">
            ...
            <Table striped bordered hover
                ...
                <tr>
                    <td>B</td>
                    <td>その他所得</td>
                    <td>{params["sonota_shotoku"].toLocaleString()}</td>
                    <td></td>
                    <td></td>
                </tr>
                <tr>
            ...
            <Table striped bordered hover
                ...
                <tr>
                    <td>E</td>
                    <td>配偶者特別控除</td>
                    <td>{haiguusha_tokubetsu_koujo.toLocaleString()}</td>
                </tr>
                <tr>
                    <td>F</td>
                    <td>障害者控除</td>
                ...
                <tr>
                    ...
                    <td>{kojin_koujo.toLocaleString()}</td>
                    <td></td>
